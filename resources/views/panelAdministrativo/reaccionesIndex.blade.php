        ...
        @foreach($reacciones as $reaccion)
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalEliminar{{$reaccion->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form method="post" action="{{ route('reacciones.destroy' , ['id'=>$reaccion->id]) }}">
                                        @csrf
                                        @method('delete')
