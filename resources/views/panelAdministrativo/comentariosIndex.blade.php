...
@section('contenido')
    ...
    <h3>  |   Comentarios </h3>
    <hr>
    <form action="{{ route('comentarios.search') }}"  class="" role="search" style="width: 160%; align-content: flex-end;">
        <div class="row">
            <div class="col">
                    ...
                    <td style="text-align: center;">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="# " data-bs-toggle="modal" data-bs-target="#modalEliminar{{$comentario->id}}">Eliminar</a></li>
                            </ul>
                        </div>
