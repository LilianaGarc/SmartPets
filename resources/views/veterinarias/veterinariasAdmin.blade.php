...
<div class="container-fluid px-0">
    ...
    <h1 class="d-flex justify-content-between align-items-center mb-2">Veterinarias
                            ...
                            <div class="modal-content bg-light">
                                <div class="modal-header">
                                    <h5 class="modal-title fw-bold" id="modalLabel{{$veterinaria->id}}">
                                        <i class="fas fa-exclamation-triangule text-danger"></i>Eliminar {{ $veterinaria->nombre }}</h5>
